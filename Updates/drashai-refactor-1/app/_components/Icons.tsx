// All 24 SVG icons. Lifted verbatim from the old `const I = {...}` blob in app/page.tsx.
// Single import surface so any component can do: `import { I } from '@/app/_components/Icons'`.
