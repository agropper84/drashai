// Plan 5 — phase is now string (custom workflow phases supported).
// Otherwise identical to Plan 4 types.
...
export interface Encounter {
  ...
  status?: string;
  workflowId?: string;
  /** Plan 5 — widened from a strict union; custom workflows define their own phases. */
  phase?: string;
